...
/**
 * This is a copy of the {@link ResettingBoxMullerGaussianSampler} modified so
 * the sampler can be reset to ensure all tests generate the same random
 * samples.
 */
public class ResettingBoxMullerGaussianSampler extends SamplerBase
